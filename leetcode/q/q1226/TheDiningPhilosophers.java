...
public class TheDiningPhilosophers {
    public static void main(String[] args) {
        DiningPhilosophers solution = new TheDiningPhilosophers().new DiningPhilosophers();
    }

    //leetcode submit region begin(Prohibit modification and deletion)
    class DiningPhilosophers {
        final ReentrantLock [] forks;
        final Semaphore eatLimit;
        public DiningPhilosophers() {
            this.forks = new ReentrantLock[]{
                new ReentrantLock(),
                new ReentrantLock(),
                new ReentrantLock(),
                new ReentrantLock(),
